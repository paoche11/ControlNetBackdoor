...
from diffusers import (
    ...
    UNet2DConditionModel, DDIMScheduler, PNDMScheduler,
)
...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        "--pretrained_model_name_or_path",
        type=str,
        default=Config.DiffusionModelSavePath,
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default=Config.PretrainedModelOutputPath,
    ...
    parser.add_argument(
        "--train_batch_size", type=int, default=Config.BatchSize,
...
def main(args):
    ...
    if args.tokenizer_name:
        ...
        print("arg:", args.pretrained_model_name_or_path)
    ...
    for epoch in range(first_epoch, Config.Epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(unet):
                ...
                timesteps = torch.randint(0, Config.TrainTimeSteps, (bsz,), device=model_input.device)
                timesteps = timesteps.long()

                noisy_model_input = noise_scheduler.add_noise(model_input, noise, timesteps)

                if not is_backdoor_train:
